...
int max_matrix(int ray[3][3], int row, int col)
{
    int max = ray[0][0];
    for (int i = 0; i < row; i++)
    {
...
int min_matrix(int ray[3][3], int row, int col)
{
    int min = ray[0][0];
    for (int i = 0; i < row; i++)
    {
...
int main()
{
    ...
    print_ray(ray, 3, 3);
    cout << "----------------" << endl;
    cout << "The Max is: " << max_matrix(ray, 3, 3) << endl;
    cout << "The Min is: " << min_matrix(ray, 3, 3) << endl;
    return 0;
}
