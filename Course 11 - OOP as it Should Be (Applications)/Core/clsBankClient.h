...
class clsBankClient : public clsPerson
{
    ...
    {
        fstream MyFile;
        MyFile.open("./Core/Clients.txt", ios::out | ios::app);
    ...
    static vector <clsBankClient> _LoadClientsDataFromFile()
    {
        ...
        fstream MyFile;
        MyFile.open("./Core/Clients.txt", ios::in);//read Mode
    ...
    {
        fstream MyFile;
        MyFile.open("./Core/Clients.txt", ios::out);//overwrite
    ...
    void _RegisterTransferLog(float Amount, clsBankClient DestinationClient, string Username)
    {
        ...
        fstream MyFile;
        MyFile.open("./Screens/Transfer Screen/TransferLog.txt", ios::out | ios::app);
    ...
    static vector <stTrnsferLogRecord> GetTransfersLogList()
    {
        ...
        fstream MyFile;
        MyFile.open("./Screens/Transfer Screen/TransferLog.txt", ios::in);//read Mode
