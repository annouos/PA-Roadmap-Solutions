...
void fill_sum_ray(int ray[3][4], int ray_sum[3], short row_number, short col)
{
    for (short i = 0; i < row_number; i++)
    {
        ray_sum[i] = sum_ray(ray,i, col);
    }
}
...
void print_sum(int ray[3] ,short row)
{
    cout << "\nThe sum of matrix is: \n";
    for (short i = 0; i < row; i++)
    {
        cout << "\nRow in " << i+1 << " sum = " << ray[i] << endl;
    }
}
